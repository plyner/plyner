...
//**************** Dados Basicos para Envio de Mensagem no WhatsApp com Imagem Jpeg/PNG **************************
		...
		$data = file_get_contents('teste-imagem.png');

		//Converte o arquivo em string base64
		$media = base64_encode($data);

		// Define o corpo da requisição como um JSON
		$data = array('meuid' => 36, 'senha' => '22222', 'destinatario' => '11991215555', 'msg' => 'teste com imagem', 'enviador' => 191, 'tipoanexo' => 1, 'anexomsg' => 'teste-imagem.png', 'anexo64' => $media);
