...
//**************** Dados Basicos para Adicionar um Novo Enviador WhatsApp **************************
		...
		$acaoenviador = 'adicionar'; // adicionar, apagar, status, ativos

		// Define o corpo da requisição como um JSON
		$data = array('meuid' => 36, 'senha' => '2222', 'acaoenviador' => $acaoenviador, 'numenviador' => '11991215060', 'apelido' => 'Enviador teste');
