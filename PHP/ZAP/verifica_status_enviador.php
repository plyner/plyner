...
//**************** Dados Basicos para Adicionar um Novo Enviador WhatsApp **************************
		...
		$acaoenviador = 'status'; // adicionar, apagar, status, ativos
		$idenviador = 141; // IdEnviador do telefone que sera consultado o status

		// Define o corpo da requisição como um JSON
		$data = array('meuid' => 36, 'senha' => '2222', 'acaoenviador' => $acaoenviador, 'idenviador' => $idenviador);
