...
//**************** Dados Basicos para Envio de Mensagem no WhatsApp com Arquivo XML **************************
		...
		$data = file_get_contents('planilha.xls');

		//Converte o arquivo em string base64
		$media = base64_encode($data);

		// Define o corpo da requisição como um JSON
		$data = array('meuid' => 36, 'senha' => '2222', 'destinatario' => '16991214371', 'msg' => 'teste com Excel', 'enviador' => 191, 'tipoanexo' => 6, 'anexomsg' => 'ExemploXML.xml', 'anexo64' => $media);
