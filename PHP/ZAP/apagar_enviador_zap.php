...
//**************** Dados Basicos para Apagar Enviador do Plyner **************************
		...
		$acaoenviador = 'apagar'; // adicionar, apagar, status, ativos
		$idenviador = 141; // IdEnviador do telefone que sera Removido do seu Plyner

		// Define o corpo da requisição como um JSON
		$data = array('meuid' => 36, 'senha' => '2222', 'idenviador' => $idenviador, 'acaoenviador' => $acaoenviador);
