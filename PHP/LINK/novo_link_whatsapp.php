...
//**************** Dados Basicos para Apagar Enviador do Plyner **************************
		...
		$tipo = 2; // 1 - URL, 2 - ZAP, 3 - URL + ZAP
		$apelido = 'teste link 2'; // Apelido do link que sera criado - OPCIONAL
		...
		$data = array('meuid' => 36, 'senha' => '2222', 'acao' => $acao, 'tipo' => $tipo, 'apelido' => $apelido, 'numtelzap' => $numtelzap, 'introzap' => $introzap, 'exclusao' => 1);
