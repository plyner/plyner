...
//**************** Dados Basicos para Apagar Enviador do Plyner **************************
		...
		$tipo = 1; // 1 - URL, 2 - ZAP, 3 - URL + ZAP
		$apelido = 'teste link 1'; // Apelido do link que sera criado - OPCIONAL
		...
		$data = array('meuid' => 36, 'senha' => '2222', 'acao' => $acao, 'tipo' => $tipo, 'apelido' => $apelido, 'url' => $url, 'exclusao' => 1);
