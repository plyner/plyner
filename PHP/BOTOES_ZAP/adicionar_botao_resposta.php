...
//**************** Dados Basicos para Adicionar um Novo Enviador WhatsApp **************************
        ...
        $legendabotao = 'Ser Atendido pelo Vendedor'; // texto de legenda do Botao
        $tipobotao = 1; // 1 = Botao de Resposta, 2 = Botao para acessar endereco URL, 3 = Botao para iniciar ligacao telefonica, 4 = Botao para copiar um conteudo, semelhante ao Ctrl + C

		// Define o corpo da requisição como um JSON
		$data = array('meuid' => 36, 'senha' => '2222', 'acaobotao' => $acaobotao, 'idconjunto' => $idconjunto, 'legendabotao' => $legendabotao, 'tipobotao' => $tipobotao );
