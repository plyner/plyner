...
//**************** Dados Basicos para Adicionar um Novo Enviador WhatsApp **************************
        ...
        $legendabotao = 'Acessar nosso site'; // texto de legenda do Botao
        $tipobotao = 2; // 1 = Botao de Resposta, 2 = Botao para acessar endereco URL, 3 = Botao para iniciar ligacao telefonica, 4 = Botao para copiar um conteudo, semelhante ao Ctrl + C
        $linkurl = 'https://plyner.com.br/inicial'; // Informe o endereco URL que sera acessado pelo Link Ex: https://plyner.com.br/inicial ou https://wa.me/5511999995555

		// Define o corpo da requisição como um JSON
		$data = array('meuid' => 36, 'senha' => '2222', 'acaobotao' => $acaobotao, 'idconjunto' => $idconjunto, 'legendabotao' => $legendabotao, 'tipobotao' => $tipobotao, 'linkurl' => $linkurl );
