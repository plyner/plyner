...
//**************** Dados Basicos para Adicionar um Novo Enviador WhatsApp **************************
        ...
        $tipo = 2; // 1 = lista de opcoes, 2 = conjunto de botoes
        $apelido = 'Conjunto teste 1'; // nome deste conjunto de botoes dentro do seu Plyner (Opcional)
        $titulo = 'Como voce deseja ser atendido...'; // Titulo que sera mostrado na mensagem do Whastapp
        $exclusao = 1; // 1 = Sera auto excluido em 30 dias, 0 = Nao sera auto excluido

		// Define o corpo da requisição como um JSON
		$data = array('meuid' => 36, 'senha' => '2222', 'acaobotao' => $acaobotao, 'tipo' => $tipo, 'apelido' => $apelido, 'titulo' => $titulo, 'exclusao' => $exclusao );
