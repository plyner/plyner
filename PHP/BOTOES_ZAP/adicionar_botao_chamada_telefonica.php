...
//**************** Dados Basicos para Adicionar um Novo Enviador WhatsApp **************************
        ...
        $legendabotao = 'Chamar um Vendedor'; // texto de legenda do Botao
        $tipobotao = 3; // 1 = Botao de Resposta, 2 = Botao para acessar endereco URL, 3 = Botao para iniciar ligacao telefonica, 4 = Botao para copiar um conteudo, semelhante ao Ctrl + C
        $numtelefone = '11999995566'; // Informe o numero de telefone com DDD, que sera feita a chamada telefonica

		// Define o corpo da requisição como um JSON
		$data = array('meuid' => 36, 'senha' => '2222', 'acaobotao' => $acaobotao, 'idconjunto' => $idconjunto, 'legendabotao' => $legendabotao, 'tipobotao' => $tipobotao, 'numtelefone' => $numtelefone );
